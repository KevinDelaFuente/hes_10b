 ...
 * Palindrome.java
 * 
 * A program that determines whether a user-inputted string is a palindrome.
 * Ignores spaces, punctuation, and case differences.
 * Test cases commented out below.
 */
class Palindrome {
     ...
     * Assumes input has already been converted to lowercase.
     */
